...
public class MongoTest extends ServiceBase implements TestIntf {
	...
	public void testComplexProperties() {
		...
		new APObj().put("url", "https://files.mastodon.social/custom_emojis/images/000/224/097/original/d9c5e447581399a9.gif"))));
	...
	public void runBinaryTests(MongoSession ms) {
		...
		try {
			...
			attach.writeStream(ms, false, "", node, new LimitedInputStreamEx(new FileInputStream("/home/clay/test-image.png"), maxFileSize), null, "image/png", null);
			update.save(ms, node);
